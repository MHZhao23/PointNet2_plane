...
class SyntheticData(Dataset):
    ...
    def __init__(self, rootpath1, rootpath2, num_classes, num_point, train_ratio1, train_ratio2, mod, block_size=1.0):
        ...
        print(f"loading {len(split_indices1)} plane scenes ...")
        ...
        if mod == "train":
            ...
            raise Exception("mod should be train or test")
        print(f"loading {len(split_indices2)} non-plane scenes ...")
        ...
        print(f"loading {len(self.points_list)} point cloud successfully!")
